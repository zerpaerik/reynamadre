  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Comisiones por Pagar a Profesionales</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Comisiones por Pagar a Profesionales</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    @include('flash-message')
      ...
      <div class="card">
              ...
              <form method="get" action="reporte_compagar1">					
                  ...
                  <div class="col-md-3">
                    <label for="exampleInputEmail1">Seleccione el Profesional</label>
