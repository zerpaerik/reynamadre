    ...
    @include('flash-message')
      ...
      <div class="card">
              <div class="card-header">
                <a class="btn btn-primary btn-sm" href="{{route('salida.create')}}">
                              <i class="fas fa-folder">
                              </i>
                              Agregar
                          </a>
                          <form method="get" action="salida-productos">	
                          <div class="row">				
                          <div class="col-md-3">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    @if(Auth::user()->rol == 1)
                          ...
                          <a class="btn btn-danger btn-sm" href="salida-reversarl-{{$i->id}}" onclick="return confirm('¿Desea Reversar este registro?')">
