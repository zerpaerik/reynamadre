  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Reporte individual</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    @include('flash-message')
      ...
      <div class="card">
              ...
              <form method="get" action="reporte_individual">					
              ...
              <div class="card-body">
                <table id="" class="table table-bordered table-striped">
                  ...
                  <tr>
                   ...
                   <td>{{$an->monto}}</td>                 
                    <td>
                    <a target="_blank" class="btn btn-success btn-sm" href="rep-ind/{{$tipo}}/{{$an->id_tipo}}/{{$f1}}/{{$f2}}">
