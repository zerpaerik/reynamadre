  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Producción Consultas</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Producción Consultas</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    @include('flash-message')
      ...
      <div class="card">
              ...
              <form method="get" action="produccion_consultas">					
              ...
              <div class="card-body">
                <table id="" class="table table-bordered table-striped">
                  ...
                  <td>{{$an->monto}}</td> 
                  <td>
                    <a target="_blank" class="btn btn-success btn-sm" href="prod-cons/{{$an->atendido}}/{{$f1}}/{{$f2}}">
