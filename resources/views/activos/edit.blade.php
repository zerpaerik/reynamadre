        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="post" action="activos/edit">
					{{ csrf_field() }}                
                    <div class="card-body">
                    <div class="row">
                  <div class="col-md-4">
                    <label for="exampleInputEmail1">Nombre</label>
                    <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre" require value="{{$activo->nombre}}">
                  </div>
                  <div class="col-md-4">
                  ...
                  <label>Estado de Activo</label>
                        <select class="form-control" name="estado" value="{{$activo->estado}}">
