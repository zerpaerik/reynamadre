        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="post" action="productos/edit" accept-charset="UTF-8" enctype="multipart/form-data">
					{{ csrf_field() }}                
                    <div class="card-body">
                    <div class="row">
                  <div class="col-md-3">
                    <label for="exampleInputEmail1">Nombre</label>
                    <input type="text" class="form-control" id="nombre" value="{{$productos->nombre}}" name="nombre" placeholder="Nombre de producto">
                  </div>
                  <div class="col-md-3">
                  ...
                  <label>Unidad de Medida</label>
                      ...
                      @if($productos->medida == $uni->nombre)
                      <option value="{{$productos->medida}}" selected="selected">
                        {{$productos->medida}} 
                      </option>
                      @else
                      <option value="{{$uni->nombre}}">
                        {{$uni->nombre}} 
                      </option>
                      @endif
                      @endforeach
                  ...
                  <div class="col-md-3">
                    ...
                    <input type="number" class="form-control" id="minimo" value="{{$productos->minimo}}" name="minimo" placeholder="Cantidad Mínima" required>
                  </div>
