        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="post" action="ingreso/productos">
					{{ csrf_field() }}                
                    <div class="card-body">
                    <div class="row">
                  <div class="col-md-4">
                    <label for="exampleInputEmail1">Factura</label>
                    <input type="text" class="form-control" id="nombre" name="factura" placeholder="Factura" required>
                  </div>
                  <div class="col-md-4">
                    <label for="exampleInputEmail1">Fecha de Factura</label>
                    <input type="date" class="form-control" id="nombre" name="fecha" placeholder="Descripción de producto" required>
                  </div>

                  <div class="col-md-4">
                    <label for="exampleInputEmail1">Observación</label>
                    <input type="text" class="form-control" id="nombre" name="observacion" placeholder="Observación">
                  </div>
                  </div>
            ...
            <div id="laboratorios" class="embed ">
                ...
                <div id="laboratorios_template" class="template row">
                    ...
                    <label for="laboratorios_#index#_laboratorio" class="col-sm-1 control-label">Product.</label>
                    <div class="col-sm-3">
                      <select id="laboratorios_#index#_laboratorio" name="id_laboratorio[laboratorios][#index#][laboratorio]" class="selectLab form-control">
                        ...
                        @foreach($productos as $pac)
                          <option value="{{$pac->id}}">
                          <b>{{$pac->nombre}}</b> Medida:{{$pac->medida}} 
                          </option>
                        @endforeach
                      </select>
                    </div>
