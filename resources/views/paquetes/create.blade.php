        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="paquetes/create" accept-charset="UTF-8" enctype="multipart/form-data">					
              {{ csrf_field() }}                
                    <div class="card-body">
                    <div class="row">
                  <div class="col-md-4">
                    <label for="exampleInputEmail1">Nombre</label>
                    <input onkeyup="javascript:this.value=this.value.toUpperCase();" type="text" class="form-control" id="name" name="nombre" placeholder="Nombre de Paquete" required>
                  </div>
                 
                  <div class="col-md-4">
                    <label for="exampleInputEmail1">Precio</label>
                    <input type="number" class="form-control" id="email" name="precio" placeholder="Precio" required>
                  </div>
                  <div class="col-md-4">
                    <label for="exampleInputEmail1">Porcentaje</label>
                    <input type="number" class="form-control" id="name" name="porcentaje" placeholder="Porcentaje Personal" required>
                  </div>
                  </div>
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="number" class="form-control" id="email" name="controles" placeholder="Cantidad Controles" required>
                  </div>
                  <div class="col-md-4">
                    <label for="exampleInputEmail1">Cantidad Consultas</label>
                    <input type="number" class="form-control" id="name" name="consultas" placeholder="Cantidad Consultas" required>
                  </div>
                  </div>
                  <br>
						...
						<div class="row">
				            ...
				            <div id="servicios" class="embed ">
				                ...
				                <div id="servicios_template" class="template row">
				                    ...
				                    <label for="servicios_#index#_servicio" class="col-sm-3 control-label">Servicio</label>
				                    <div class="col-sm-12">
						...
						<div class="row">
				            ...
				            <div id="laboratorios" class="embed ">
				                ...
				                <div id="laboratorios_template" class="template row">
				                    ...
				                    <label for="laboratorios_#index#_laboratorio" class="col-sm-3 control-label">Lab</label>
				                    <div class="col-sm-12">
