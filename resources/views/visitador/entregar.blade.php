  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Comisiones por Entregar</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Comisiones por Entrega</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    @include('flash-message')
      ...
      <div class="card">
              ...
              <form method="get" action="comisiones-por-entregar">					
                  ...
                  <tr>
                    ...
                    <td>
                                <form method="get" action="entregar">
                                    <input type="hidden" value="{{$an->recibo}}" name="id">
