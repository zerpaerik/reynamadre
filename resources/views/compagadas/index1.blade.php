  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Comisiones Pagadas a Profesional</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    @include('flash-message')
      ...
      <div class="card">
              ...
              <form method="get" action="comisionesp1">					
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    @if(Auth::user()->rol == 1)
                          ...
                          <a class="btn btn-danger btn-sm" href="comisionesp-reversar-{{$an->recibo}}" onclick="return confirm('¿Desea reversar este pago?')">
