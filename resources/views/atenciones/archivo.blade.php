  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Guardar Comprobantes</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Atenciones</a></li>
              <li class="breadcrumb-item active">Guardar Comprobantes</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                    <div class="card-body">
                    <form method="post" action="atenciones_archivo" enctype="multipart/form-data">			
                  {{ csrf_field() }}  					
...
<label class="col-sm-12 alert"><i class="fa fa-tasks" aria-hidden="true"></i> Listado de Archivos</label>
            <!-- sheepIt Form -->
            <div id="laboratorios" class="embed ">
                ...
                <div id="laboratorios_template" class="template row">
                 ...
                 <label for="laboratorios_#index#_monto" class="col-sm-1 control-label">Adjunte archivo</label>
                  

                  <div class="col-sm-3">
                    <input id="laboratorios_#index#_montos" name="monto_ls[laboratorios][#index#][montos]" type="file"  data-toggle="tooltip" data-placement="bottom">
                  </div>
          ...
          <input type="hidden" name="id_atencion" value="{{$id}}">
