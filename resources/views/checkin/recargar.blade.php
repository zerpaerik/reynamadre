  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Recarga de Horas</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Movimientos</a></li>
              <li class="breadcrumb-item active">Recarga de Horas</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                  ...
                  <form method="post" action="checkin/recargar" >			
                  {{ csrf_field() }}  
                  ...
                  <div class="col-md-3">
                    ...
                    <p>{{$cliente->nombre}} {{$cliente->responsable}}
                  </div>
                  <div class="col-md-3">
                  ...
                  <div class="col-md-4">
                    <label for="exampleInputEmail1">Horas a recargar</label>
                    <input type="number" maxlength="2" class="form-control" id="email" name="horas" placeholder="Horas a recargar" required>
                  </div>
