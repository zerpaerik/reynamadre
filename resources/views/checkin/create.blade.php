        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              {{ csrf_field() }}                
                    <div class="card-body">
                    <form method="get" action="checkin-create">					
                  ...
                  <select class="form-control" data-placeholder="Seleccione" style="width: 100%;" name="habitacion" required>
                   @foreach($analisis as $a)
                   <option value="{{$a->id}}">{{$a->nombre}} Descripción:{{$a->descripcion}}</option>
                    @endforeach
                  </select>
