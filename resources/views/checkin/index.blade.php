    ...
    @include('flash-message')
      ...
      <div class="card">
              <div class="card-header">
                <a class="btn btn-primary btn-sm" href="{{route('ckeckin.create')}}">
                  ...
                  <div class="col-md-2">
                    ...
                    <input type="text" disabled class="form-control" value="{{$soli->cantidad}}" name="inicio" placeholder="Buscar por dni" onsubmit="datapac()">
                  </div>
                  <div class="col-md-2">
                    <label for="exampleInputEmail1">Total</label>
                    <input type="text" disabled class="form-control" value="{{$soli->monto}}" name="inicio" placeholder="Buscar por dni" onsubmit="datapac()">
                  </div>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>{{$so->laboratorio}} {{$so->observacion}}</td>
                    <td>{{$so->precio}}</td>
                    <td>{{$so->tipopago}}</td>
                    @if($so->estatus == 1)
                    ...
                    <td>
                    <a class="btn btn-default btn-sm" href="checkin-recargar-{{$so->id}}">
                              <i class="fas fa-add">
                              </i>
                              Recargar Horas
                              </a>
                          <a target="_blank" class="btn btn-success btn-sm" href="checkin-ticket-{{$so->id}}">
                              <i class="fas fa-print">
                              </i>
                              Ticket
                              </a>
                              @if(Auth::user()->rol == 1)
                              <a class="btn btn-primary btn-sm" href="checkin-edit-{{$so->id}}">
                              <i class="fas fa-edit">
                              </i>
                              Editar
                              ...
                              <a class="btn btn-danger btn-sm" href="checkin-delete-{{$so->id}}" onclick="return confirm('¿Desea Eliminar este registro?')">
