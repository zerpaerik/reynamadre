          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              {{ csrf_field() }}                
                  ...
                  <form method="post" action="checkin/edit" >			
                  {{ csrf_field() }}  

                  <div class="row">
                  <div class="col-md-8">
                  <label>Datos de Huesped</label>
                  <p>{{$solicitudes->nompac}} {{$solicitudes->apepac}} Documento: {{$solicitudes->identificacion}}
                  ...
                  <label>Tipo de Pago</label>
                        ...
                        @if($solicitudes->tipopago == 'EF')
							<option selected="selected" value="EF">EF</option>
                            <option value="TJ">TJ</option>
                        @else
                        <option value="EF">EF</option>
                            <option selected="selected" value="TJ">TJ</option>
                        @endif
                  ...
                  <select class="form-control" data-placeholder="Seleccione" style="width: 100%;" name="habitacion">
                     ...
                     @foreach($analisis as $a)
                        @if($solicitudes->habitacion == $a->id)
                          <option value="{{$a->id}}" selected="selected">
                          {{$a->nombre}} Descripción:{{$a->descripcion}} Precio:{{$a->precio}}
                          </option>
                        @else
                          <option value="{{$a->id}}">
                          {{$a->nombre}} Descripción:{{$a->descripcion}} Precio:{{$a->precio}}
