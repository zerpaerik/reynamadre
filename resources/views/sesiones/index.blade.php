  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Sesiones por Atender</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Sesiones por Atender</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @foreach($sesiones as $an)
                  <tr>
                    <td>{{$an->created_at}}</td>
                    <td>{{$an->apellidos}} {{$an->nombres}}</td>
                    <td>{{$an->servicio}}</td>
                    <td><form method="get" action="sesiones-atender"><input type="hidden" value="{{$an->id}}" name="id">
                    ...
                    <button style="margin-left: 10px;" type="submit" class="btn btn-xs btn-danger">Atender</button>
                    </form>
