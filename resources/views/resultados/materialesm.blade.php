  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Materiales Malogrados</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      ...
      <div class="card">
              <div class="card-header">
                          ...
                          <form method="get" action="materiales-malogrados">					
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @foreach($materiales as $eq)
                  <tr>
                    <td>{{$eq->apellidos}} {{$eq->nombres}}</td>
                    <td>{{$eq->placa}}</td>
                    <td><span class="badge bg-success">{{$eq->cantidad}}</span></td>
                    <td>{{$eq->servicio}}</td>
                    <td>{{ Carbon\Carbon::createFromDate($eq->created_at)->format('d-m-Y')  }}</span></td>
                    <td>{{$eq->lasto}} {{$eq->nameo}}</td>
