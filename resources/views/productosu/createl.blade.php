        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                    <div class="card-body">
                    <form method="post" action="productos-usados/createl" >			
                  {{ csrf_field() }}  					
            ...
            <div id="servicios" class="embed ">
                ...
                <label for="laboratorios_#index#_laboratorio" class="col-sm-2 control-label">Producto</label>
                    ...
                    <label for="servicios_#index#_monto" class="col-sm-2 control-label">Cant.Actual</label>
                    <div class="col-sm-2">
                      <input id="servicios_#index#_montoHidden" name="monto_h[servicios][#index#][montoHidden]" class="text" type="hidden" value="">

                      <input id="servicios_#index#_monto" name="monto_s[servicios][#index#][monto]" type="text" class="number form-control monto" placeholder="Cant.Actual" data-toggle="tooltip" data-placement="bottom" title="Monto" disabled>
                    </div>
...
$(document).on('change','.selectServ',function(){
      ...
      $.ajax({
         type: "GET",
         url:  "productos/getProductoAlmacenl/"+$(this).val(),
         success: function(a) {
           
            $('#servicios_'+id+'_montoHidden').val(a.cantidad);
            $('#servicios_'+id+'_monto').val(a.cantidad);
